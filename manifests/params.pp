...
class puppet::params {
  ...
  case $::osfamily {
    ...
    'Debian': {
      ...
      $puppset_server_confdir       =  '/etc/puppetlabs/puppetserver'
      $puppset_server_conf_d        =  "${puppset_server_confdir}/conf.d"
      $puppset_server_services_d    =  "${puppset_server_confdir}/services.d"
